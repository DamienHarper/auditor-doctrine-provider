...
`auditor-doctrine-provider` brings the auditing features of [`auditor`](https://github.com/DamienHarper/auditor) to applications using [Doctrine ORM](https://www.doctrine-project.org/projects/orm.html).
